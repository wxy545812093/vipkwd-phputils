...
use Vipkwd\Utils\Libs\Qrcode as PHPQRcode;
...
class Qrcode {
     ...
     * @return void
     */
    static function qrcode(string $text, $outFile = false, string $level = "7%", int $size = 6, int $margin = 2, bool $saveAndPrint = false){
