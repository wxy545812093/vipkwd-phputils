 ...
 */
class Code39 extends Image_Barcode2_Common implements Image_Barcode2_Driver, Image_Barcode2_DualWidth
{
    /**
     * Coding map
     * @var array
    ...
    public function validate()
    {
        ...
        if (preg_match("/[^0-9A-Za-z\-*+\$%\/. ]/", $this->getBarcode())) {
            throw new Image_Barcode2_Exception('Invalid barcode(...need chars match /\w+/)');
        }
    }
