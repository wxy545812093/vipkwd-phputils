...
class WxPayDownloadBill extends WxPayDataBase
{
     ...
     * @param string $value
     **/
    public function setAttrBillDate($value)
    {
     ...
     * @return 值
     **/
    public function getAttrBillDate()
    {
     ...
     * @return true 或 false
     **/
    public function hasAttrBillDate()
    {
     ...
     * @param string $value
     **/
    public function setAttrBillType($value)
    {
     ...
     * @return 值
     **/
    public function getAttrBillType()
    {
     ...
     * @return true 或 false
     **/
    public function hasAttrBillType()
    {
