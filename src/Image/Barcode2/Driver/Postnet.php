 ...
 * @link      http://pear.php.net/package/Image_Barcode2
 */
class Postnet extends Image_Barcode2_Common implements Image_Barcode2_Driver, Image_Barcode2_DualHeight
{
    /**
     * Bar short height
     *
    ...
    public function validate()
    {
        ...
        if (!preg_match('/^[0-9]+$/', $this->getBarcode())) {
            throw new Image_Barcode2_Exception('Invalid barcode(...need chars match /^[0-9]+$/)');
        }
    }
